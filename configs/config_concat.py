...
class AugmentConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--tiny_imagenet_path', type=str, default='/data/datasets/TinyImageNet', help='This is the dir for Greene repository')
        parser.add_argument('--imagenet_train_path', type=str, default='/data/datasets/ImageNet/')
        parser.add_argument('--imagenet_valid_path', type=str, default='/data/datasets/ImageNet/val')
        # PC-DARTS Version
        ...
        parser.add_argument('--imagenet_stem_relu', action='store_true')
        parser.add_argument('--label_smooth', type=float, default=0.1, help='label smoothing')
        parser.add_argument('--lr_scheduler_imagenet', type=str, default='linear')
        parser.add_argument('--no_balancing', action='store_true', help='removing the ReLU balancing: multiply channel by 2')
    ...
    def __init__(self):
        ...
        self.data_path = './data/'
        self.path = os.path.join('/scratch/mc8065/augments', self.name)
